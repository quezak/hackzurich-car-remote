...
//			if (gyroState.eulerAngles.z > 180.0f) {
//				Vector3 angles = gyroState.eulerAngles;
//				angles.z = 360.0f - angles.z;
//				gyroState = Quaternion.Euler(angles);
//			}
...
//			float linearAngle = rotationZ.eulerAngles.z;
			...
			Utils.LogEveryN(10, String.Format("raw rotation: x={0:F2} y={1:F2} z={2:F2}",
				gyroState.eulerAngles.x, gyroState.eulerAngles.y, gyroState.eulerAngles.z));
